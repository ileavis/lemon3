...
public class AmapController {
    ...
    GenericRspDTO<String> getWeatherInfo(@Validated @NotBlank String cityCode) {
        String weather = amapService.getWeatherInfo(cityCode);
        return GenericRspDTO.success(weather);
    }
    ...
    GenericRspDTO<String> ip2Location(@Validated @NotBlank String ipv4) {
        String ipLocation = amapService.ip2Location(ipv4);
        return GenericRspDTO.success(ipLocation);
    }
}
